...
<html>
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# githubog: http://ogp.me/ns/fb/githubog#">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>zabbix-templates/apache/apache_status.sh at master · rdvn/zabbix-templates · GitHub</title>
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="github" name="octolytics-app-id" /><meta content="B4A85512:1FA7:204D39E2:525E4CB6" name="octolytics-dimension-request_id" />
...
<meta content="/JhBpD6odHYVuxzQ7Yyr+CVZ8sZhGvaTOmoNCRBKlZM=" name="csrf-token" />
    ...
    <link href="https://github.global.ssl.fastly.net/assets/github2-cc43a394e192dbfe81aa4563f81267f5c57f6a6a.css" media="all" rel="stylesheet" type="text/css" />
      ...
      <meta http-equiv="x-pjax-version" content="db4d160d5567069aebed4609926ba577">
        ...
        <link data-pjax-transient rel='permalink' href='/rdvn/zabbix-templates/blob/6c5d0d6c3db508d8b048032a3cbbcfdbbbe6ba30/apache/apache_status.sh'>
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions">
      ...
      <a class="button signin" href="/login?return_to=%2Frdvn%2Fzabbix-templates%2Fblob%2Fmaster%2Fapache%2Fapache_status.sh">Sign in</a>
    </div>
...
<!-- blob contrib key: blob_contributors:v21:122d7c597176c1ece669ae02aa97d154 -->
...
<div class="select-menu js-menu-container js-select-menu" >
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item selected">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/rdvn/zabbix-templates/blob/master/apache/apache_status.sh"
                 data-name="master"
                 data-skip-pjax="true"
                 rel="nofollow"
  ...
  <div class="breadcrumb">
    <span class='repo-root js-repo-root'><span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/rdvn/zabbix-templates" data-branch="master" data-direction="back" data-pjax="true" itemscope="url"><span itemprop="title">zabbix-templates</span></a></span></span><span class="separator"> / </span><span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/rdvn/zabbix-templates/tree/master/apache" data-branch="master" data-direction="back" data-pjax="true" itemscope="url"><span itemprop="title">apache</span></a></span><span class="separator"> / </span><strong class="final-path">apache_status.sh</strong> <span class="js-zeroclipboard minibutton zeroclipboard-button" data-clipboard-text="apache/apache_status.sh" data-copied-hint="copied!" title="copy to clipboard"><span class="octicon octicon-clippy"></span></span>
  </div>
</div>
  ...
  <div class="commit file-history-tease">
      <img class="main-avatar" height="24" src="https://2.gravatar.com/avatar/b44d6cf11c83e8459436eddb9c6622b1?d=https%3A%2F%2Fa248.e.akamai.net%2Fassets.github.com%2Fimages%2Fgravatars%2Fgravatar-user-420.png&amp;s=140" width="24" />
      <span class="author"><span rel="author">rdvn</span></span>
      <time class="js-relative-date" datetime="2011-10-31T02:59:58-07:00" title="2011-10-31 02:59:58">October 31, 2011</time>
      <div class="commit-title">
          <a href="/rdvn/zabbix-templates/commit/cd4c0ed368906a8c0676dfaefcf1d71268db7fdc" class="message" data-pjax="true" title="initial commit for apache template">initial commit for apache template</a>
      </div>
      ...
      <div class="actions">
        <div class="button-group">
            <a class="minibutton tooltipped leftwards js-conduit-mac-openfile-check"
               ...
               data-url="github-mac://openRepo/https://github.com/rdvn/zabbix-templates?branch=master&amp;filepath=apache%2Fapache_status.sh"
               title="Open this file in GitHub for Mac">
                <span class="octicon octicon-device-desktop"></span> Open
            </a>
              <a class="minibutton disabled js-entice" href=""
                 data-entice="You must be signed in to make or propose changes">Edit</a>
          <a href="/rdvn/zabbix-templates/raw/master/apache/apache_status.sh" class="button minibutton " id="raw-url">Raw</a>
            <a href="/rdvn/zabbix-templates/blame/master/apache/apache_status.sh" class="button minibutton ">Blame</a>
          <a href="/rdvn/zabbix-templates/commits/master/apache/apache_status.sh" class="button minibutton " rel="nofollow">History</a>
        </div><!-- /.button-group -->
...
<span id="L6" rel="#L6">6</span>
            ...
            <td class="blob-line-code">
                    <div class="highlight"><pre><div class='line' id='LC1'><span class="c">#!/bin/bash</span></div><div class='line' id='LC2'><span class="k">if</span> <span class="o">[[</span> <span class="s2">&quot;$1&quot;</span> <span class="o">=</span> <span class="s2">&quot;Workers&quot;</span> <span class="o">]]</span>; <span class="k">then</span></div><div class='line' id='LC3'><span class="k">  </span>wget --quiet -O - http://localhost/server-status?auto | grep Score | grep -o <span class="s2">&quot;\.&quot;</span> | wc -l</div><div class='line' id='LC4'><span class="k">else</span></div><div class='line' id='LC5'><span class="k">  </span>wget --quiet -O - http://localhost/server-status?auto | head -n 9 | grep <span class="nv">$1</span> | awk -F <span class="s2">&quot;:&quot;</span> <span class="s1">&#39;{print $2}&#39;</span></div><div class='line' id='LC6'><span class="k">fi</span></div></pre></div>
            </td>
          </tr>
        </table>
  </div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2013 <span title="0.02117s from github-fe129-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
